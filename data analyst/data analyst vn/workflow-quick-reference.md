...
**Đọc đầy đủ**: workflow-analytics-tong-quan.md
...
Agent action:
1. Read workflow-analytics-tong-quan.md
...
- Full workflow: `workflow-analytics-tong-quan.md`
- Config template: `workflow_config.yaml`
- Agent rules: `AGENTS.md`
- Current project example: `ipynb/total/example project/`
