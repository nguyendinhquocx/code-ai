...
description_vi: Hướng dẫn tạo skills hiệu quả. Dùng khi user muốn tạo skill mới (hoặc update skill hiện có) để mở rộng capabilities của Claude với specialized knowledge, workflows, hoặc tool integrations.
keywords_vi: [skill creation, tạo skill, claude code skills, plugin, workflows, tool integration, hướng dẫn]
